...
import be.idewe.jhipster.store.config.Constants;
import com.codahale.metrics.annotation.Timed;
import be.idewe.jhipster.store.domain.User;
import be.idewe.jhipster.store.repository.UserRepository;
import be.idewe.jhipster.store.security.AuthoritiesConstants;
import be.idewe.jhipster.store.service.MailService;
import be.idewe.jhipster.store.service.UserService;
import be.idewe.jhipster.store.web.rest.vm.ManagedUserVM;
import be.idewe.jhipster.store.web.rest.util.HeaderUtil;
import be.idewe.jhipster.store.web.rest.util.PaginationUtil;
