...
import be.idewe.jhipster.store.config.audit.AuditEventConverter;
import be.idewe.jhipster.store.domain.PersistentAuditEvent;
import be.idewe.jhipster.store.repository.PersistenceAuditEventRepository;
import be.idewe.jhipster.store.service.AuditEventService;
